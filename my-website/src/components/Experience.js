...
const Experience = () => {
  return (
    <div className="section">
      ...
      <ul>
      <li className="timeline_piece" style={{ "--accent-color": "#06D504" }}>
        <div className="date">June 2025</div>
        <div className="title">Software Engineering Intern at JPMC</div>
        <div className="descr">Incoming intern in the Plano office for summer 2025!</div>
      </li>
      <li className="timeline_piece" style={{ "--accent-color": "#FE9898" }}>
      ...
      <li className="timeline_piece" style={{ "--accent-color": "#FDDE42" }}>
        <div className="date">April 2024 - September 2024</div>
        <div className="title">HackRice Tracks/Workshops Director</div>
        <div className="link">
          learn more{" "}<u><a href="https://www.hackrice.com/" target="_blank" rel="noopener noreferrer">here</a></u>
        </div>
        <div className="descr">
      ...
      <li className="timeline_piece" style={{ "--accent-color": "#06D504" }}>
        ...
        <div className="link">
          learn more{" "}<u><a href="https://jones.rice.edu/" target="_blank" rel="noopener noreferrer">here</a></u>
        </div>
        <div className="descr">
        ...
        <li className="timeline_piece" style={{ "--accent-color": "#FE9898" }}>
          ...
          <div className="title">HackRice PR & Registration Director</div>
          <div className="link">
            learn more{" "}<u><a href="https://www.hackrice.com/" target="_blank" rel="noopener noreferrer">here</a></u>
          </div>
          <div className="descr">
        ...
        <li className="timeline_piece" style={{ "--accent-color": "#FDDE42" }}>
          ...
          <div className="title">Student Computing Consultant</div>
          <div className="link">
            learn more{" "}<u><a href="https://oit.rice.edu/" target="_blank" rel="noopener noreferrer">here</a></u>
          </div>
          <div className="descr">
